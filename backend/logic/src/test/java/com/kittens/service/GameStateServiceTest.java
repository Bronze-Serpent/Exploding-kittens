...
class GameStateServiceTest
{
    ...
    public void shouldAddNewCardToPlayer()
    {
        ...
        var testCard = new OrdinaryCard("test", new Inaction(), new Inaction(), new SuddenInaction());
        ...
        gameState.getPlayerById(1L).removeCard("test");
    ...
    public void shouldPlayCard()
    {
        ...
        var card = new OrdinaryCard("test", inaction, inaction, suddenInaction);
    ...
    public void shouldThrowExceptionWhenPlayCombination()
    {
        ...
        var suddenInaction = new SuddenInaction();
        var card = new OrdinaryCard("test", inaction, inaction, suddenInaction);
        var card2 = new OrdinaryCard("test", inaction, inaction, suddenInaction);
        gameState.getPlayerById(1L).getCards().add(card);
